...
```console
$ node /home/user/tryscript/packages/tryscript/dist/bin.mjs --help
...
```console
$ node /home/user/tryscript/packages/tryscript/dist/bin.mjs --version
[..]
? 0
```
...
```console
$ node /home/user/tryscript/packages/tryscript/dist/bin.mjs readme --raw | head -5
# tryscript
...
```console
$ node /home/user/tryscript/packages/tryscript/dist/bin.mjs docs --raw | head -5
...
```console
$ node -e "require('fs').writeFileSync('/tmp/pass-cli.tryscript.md', '# Test: Pass\n\n\`\`\`console\n\$ echo ok\nok\n? 0\n\`\`\`\n')" && node /home/user/tryscript/packages/tryscript/dist/bin.mjs /tmp/pass-cli.tryscript.md
...
```console
$ node -e "require('fs').writeFileSync('/tmp/fail-cli.tryscript.md', '# Test: Fail\n\n\`\`\`console\n\$ echo actual\nexpected\n? 0\n\`\`\`\n')" && node /home/user/tryscript/packages/tryscript/dist/bin.mjs /tmp/fail-cli.tryscript.md --no-diff 2>&1; echo "exit: $?"
...
```console
$ node -e "require('fs').writeFileSync('/tmp/verbose.tryscript.md', '# Test: Verbose\n\n\`\`\`console\n\$ echo hello\nhello\n? 0\n\`\`\`\n')" && node /home/user/tryscript/packages/tryscript/dist/bin.mjs /tmp/verbose.tryscript.md --verbose
...
```console
$ node -e "require('fs').writeFileSync('/tmp/quiet.tryscript.md', '# Test: Quiet\n\n\`\`\`console\n\$ echo hi\nhi\n? 0\n\`\`\`\n')" && node /home/user/tryscript/packages/tryscript/dist/bin.mjs /tmp/quiet.tryscript.md --quiet
1 passed [..]
? 0
```
...
```console
$ node -e "require('fs').writeFileSync('/tmp/filter.tryscript.md', '# Test: Alpha\n\n\`\`\`console\n\$ echo a\na\n? 0\n\`\`\`\n\n# Test: Beta\n\n\`\`\`console\n\$ echo b\nb\n? 0\n\`\`\`\n')" && node /home/user/tryscript/packages/tryscript/dist/bin.mjs /tmp/filter.tryscript.md --filter Alpha
...
```console
$ node -e "require('fs').writeFileSync('/tmp/failfast.tryscript.md', '# Test: First Fail\n\n\`\`\`console\n\$ echo wrong\nright\n? 0\n\`\`\`\n\n# Test: Second\n\n\`\`\`console\n\$ echo two\ntwo\n? 0\n\`\`\`\n')" && node /home/user/tryscript/packages/tryscript/dist/bin.mjs /tmp/failfast.tryscript.md --fail-fast --no-diff 2>&1; echo "exit: $?"
...
```console
$ node /home/user/tryscript/packages/tryscript/dist/bin.mjs /nonexistent/*.tryscript.md 2>&1; echo "exit: $?"
No test files found
exit: 1
? 0
```
...
```console
$ node -e "require('fs').writeFileSync('/tmp/exitcode.tryscript.md', '# Test: Exit Code\n\n\`\`\`console\n\$ exit 1\n? 0\n\`\`\`\n')" && node /home/user/tryscript/packages/tryscript/dist/bin.mjs /tmp/exitcode.tryscript.md --no-diff 2>&1; echo "exit: $?"
...
```console
$ node -e "require('fs').writeFileSync('/tmp/env.tryscript.md', '---\nenv:\n  MY_VAR: hello\n---\n\n# Test: Env\n\n\`\`\`console\n\$ echo \$MY_VAR\nhello\n? 0\n\`\`\`\n')" && node /home/user/tryscript/packages/tryscript/dist/bin.mjs /tmp/env.tryscript.md
...
```console
$ node -e "require('fs').writeFileSync('/tmp/patterns.tryscript.md', '---\npatterns:\n  NUM: \"[0-9]+\"\n---\n\n# Test: Patterns\n\n\`\`\`console\n\$ echo 12345\n[NUM]\n? 0\n\`\`\`\n')" && node /home/user/tryscript/packages/tryscript/dist/bin.mjs /tmp/patterns.tryscript.md
...
```console
$ node -e "require('fs').writeFileSync('/tmp/counts.tryscript.md', '# Test: A\n\n\`\`\`console\n\$ echo a\na\n? 0\n\`\`\`\n\n# Test: B\n\n\`\`\`console\n\$ echo b\nb\n? 0\n\`\`\`\n\n# Test: C\n\n\`\`\`console\n\$ echo c\nc\n? 0\n\`\`\`\n')" && node /home/user/tryscript/packages/tryscript/dist/bin.mjs /tmp/counts.tryscript.md
