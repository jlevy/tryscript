...
---
ci:quality includes docs:check, but .github/workflows/ci.yml still invokes format:check
and lint:check separately, omitting documentation validation.
Run the shared quality gate in CI so H1/footer/local-link regressions block merge.
