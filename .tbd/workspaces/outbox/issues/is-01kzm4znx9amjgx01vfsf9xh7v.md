...
---
Review R6. docs/development.md and two official .tryscript.md suites still use the
removed bin key, so the project’s own examples emit warnings.
Update them and guard official golden files against config warnings.
