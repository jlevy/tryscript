...
---
The remediation standardized runtime errors as ‘Error:’ but Commander argument/command
failures still print lowercase ‘error:’, contradicting the documented CLI style.
Configure root output once and update golden/integration assertions.
