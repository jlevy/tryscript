...
---
Review R2. Four agent session scripts execute get-tbd@0.4.2 even though it is inside the
project’s 14-day supply-chain cool-off.
Pin the newest eligible reviewed release and verify every executable fallback.
