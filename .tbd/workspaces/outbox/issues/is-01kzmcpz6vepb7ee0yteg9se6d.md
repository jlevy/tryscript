...
---
Review the codebase for duplicate logic and refactor only where reuse improves clarity.
Then run the full precommit cycle and fix every build or test failure.

## Notes

Removed duplicate c8 discovery and matcher replacement registration; retained
intentionally distinct report option builders.
