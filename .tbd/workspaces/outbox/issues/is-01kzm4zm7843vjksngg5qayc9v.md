...
---
Review R1. packages/tryscript/src/lib/runner.ts hard-codes Linux signal numbers, so
macOS and other platforms report the wrong shell-style exit code.
Use the runtime signal table and add platform-aware regression coverage.
