...
---
ROOT and CWD values are substituted before wildcard token discovery.
A directory containing text such as [..], [??], or a custom placeholder is reinterpreted
as a wildcard, allowing incorrect paths to match.
Protect path values as literal regex replacements and add regressions.
