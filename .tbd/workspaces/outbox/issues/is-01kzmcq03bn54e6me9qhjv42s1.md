...
---
Apply the test-cleanup shortcut, retaining tests that cover meaningful behavior and
removing redundant trivia.
Then run the full precommit cycle and fix every build or test failure.

## Notes

Reviewed all unit, integration, workflow, package, and golden tests.
Regression and boundary tests are behavior-focused; no redundant trivial test was
removed.
