...
---
A bare ! parses to expectedStderr='', but run.ts uses truthiness so non-empty actual
stderr can falsely pass, and block-writer omits the marker on rewrite.
Use definedness throughout, preserve the bare sentinel, and add execution/rewrite
regressions.
