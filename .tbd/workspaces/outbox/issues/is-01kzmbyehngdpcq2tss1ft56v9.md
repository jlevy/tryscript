...
---
Coverage statistics and text-report failures are swallowed, producing misleading
zero-coverage results or silent degradation.
Preserve actionable errors and consolidate external LCOV merging.
