...
---
Review suggestion S2. buildBlock, spliceBlocks, fenceOf, and BlockParts are
implementation details newly exported from the package root.
Keep them internal while retaining the intended public TestBlock compatibility.
