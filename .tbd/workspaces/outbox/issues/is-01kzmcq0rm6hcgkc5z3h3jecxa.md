...
updated_at: 2026-08-10T00:34:09.525Z
closed_at: 2026-08-10T00:34:09.525Z
close_reason: Implemented with regression coverage; all local non-security quality, build, package, unit, golden, and coverage gates pass.
---
Remove stale or unnecessary parameters and simplify function contracts.
Then run the full precommit cycle and fix every build or test failure.

## Notes

Removed the unused reportSummary options parameter and unnecessary showReadme default
while simplifying shared Markdown command signatures.
