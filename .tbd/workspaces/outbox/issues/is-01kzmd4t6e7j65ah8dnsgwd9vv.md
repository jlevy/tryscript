...
---
LCOV parsing accepts malformed numeric records as NaN, and merging mutates nested values
from the first caller-owned report because the initial clone is shallow.
Reject malformed records with source-line context, deep-clone merge inputs, and add
immutability/error regressions.
