...
---
Remove stray debugging scripts, logging, fixtures, or tests that should not ship.
Then run the full precommit cycle and fix every build or test failure.

## Notes

No production debugger, temporary instrumentation, focused test, or stray debug artifact
remains; console output is intentional CLI/script behavior.
